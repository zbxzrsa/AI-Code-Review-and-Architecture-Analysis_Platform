    ...
    (set, get) => ({
      ...
      toggleMobileDrawer: () =>
        set((state) => ({
          sidebar: {
            ...state.sidebar,
            mobileDrawerOpen: !state.sidebar.mobileDrawerOpen,
          },
        })),
      ...
      merge: (persistedState, currentState) => {
        ...
        return {
          ...
          sidebar: {
            ...
            expandedKeys:
              persisted.sidebar?.expandedKeys ??
              currentState.sidebar.expandedKeys ??
              [],
            favorites:
              persisted.sidebar?.favorites ??
              currentState.sidebar.favorites ??
              [],
          },
        };
      },
