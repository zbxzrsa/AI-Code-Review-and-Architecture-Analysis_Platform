...
CREATE INDEX
IF
  NOT EXISTS idx_analysis_user_created
  ...
  CREATE INDEX
  IF
    NOT EXISTS idx_analysis_code_hash
    ...
    CREATE INDEX
    IF
      NOT EXISTS idx_analysis_project
      ...
      CREATE INDEX
      IF
        NOT EXISTS idx_analysis_status_severity
        ...
        CREATE INDEX
        IF
          NOT EXISTS idx_issues_severity_status
          ...
          IF
            ...
            CREATE INDEX
            IF
              NOT EXISTS idx_projects_owner_updated
              ...
              CREATE INDEX
              IF
                NOT EXISTS idx_versions_project_created
                ...
                CREATE INDEX
                IF
                  NOT EXISTS idx_baselines_project_version
                  ...
                  CREATE INDEX
                  IF
                    NOT EXISTS idx_experiments_status_created
                    ...
                    IF
                      ...
                      IF
                        ...
                        CREATE INDEX
                        IF
                          NOT EXISTS idx_users_email_active
                          ON auth.users(email)
                          WHERE
                            is_active = true
                          ...
                          CREATE INDEX
                          IF
                            NOT EXISTS idx_sessions_token_expires
                            ...
                            CREATE INDEX
                            IF
                              NOT EXISTS idx_sessions_user_created
                              ...
                              IF
                                ...
                                IF
                                  ...
                                  IF
                                    ...
                                    CREATE INDEX
                                    IF
                                      NOT EXISTS idx_cost_alerts_user_triggered
                                      ...
                                      IF
                                        ...
                                        IF
                                          ...
                                          IF
                                            ...
                                            CREATE INDEX
                                            IF
                                              NOT EXISTS idx_analysis_active
                                              ...
                                              CREATE INDEX
                                              IF
                                                NOT EXISTS idx_analysis_failed
                                                ...
                                                CREATE INDEX
                                                IF
                                                  NOT EXISTS idx_issues_high_priority
                                                  ...
                                                  CREATE INDEX
                                                  IF
                                                    NOT EXISTS idx_analysis_metadata_gin
                                                    ...
                                                    CREATE INDEX
                                                    IF
                                                      NOT EXISTS idx_issues_details_gin
                                                      ON production.code_review_results
                                                      USING GIN (issue_details);
