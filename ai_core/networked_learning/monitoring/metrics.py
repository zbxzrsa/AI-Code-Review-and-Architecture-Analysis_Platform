...
class SystemMetrics:
    ...
    def to_prometheus(self) -> str:
        ...
        lines = [
            f"# HELP networked_learning_items_collected Total items collected",
            f"# TYPE networked_learning_items_collected counter",
            f"networked_learning_items_collected {self.items_collected}",
            f"",
            f"# HELP networked_learning_items_processed Total items processed",
            f"# TYPE networked_learning_items_processed counter",
            f"networked_learning_items_processed {self.items_processed}",
            f"",
            f"# HELP networked_learning_quality_score Average quality score",
            f"# TYPE networked_learning_quality_score gauge",
            f"networked_learning_quality_score {self.avg_quality_score}",
            f"",
            f"# HELP networked_learning_latency_ms Processing latency",
            f"# TYPE networked_learning_latency_ms gauge",
            f"networked_learning_latency_ms {self.avg_processing_latency_ms}",
            f"",
            f"# HELP networked_learning_cache_hit_rate Cache hit rate",
            f"# TYPE networked_learning_cache_hit_rate gauge",
            f"networked_learning_cache_hit_rate {self.cache_hit_rate}",
            f"",
            f"# HELP networked_learning_availability System availability",
            f"# TYPE networked_learning_availability gauge",
