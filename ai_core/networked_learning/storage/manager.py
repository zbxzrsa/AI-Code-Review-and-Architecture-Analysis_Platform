...
class StorageManager:
    ...
    async def _run_cleanup(self):
        ...
        _cutoff_date = datetime.now(timezone.utc) - timedelta(days=retention_days)

        # Archive and delete for sharded storage:
        # In production, this iterates shards and moves/deletes old items
        # based on _cutoff_date. Currently handled by retention policy configuration.
